...
class HumanoidVanillaCfg(LeggedRobotCfg):
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        dof_pos_range = {
            ...
            'R_Hip_yaw_joint': [-0.2, 0.2],
            'R_Knee_joint': [0.6, 0.7],
            'R_Ankle_pitch_joint': [-0.3, 0.0],
            'R_Ankle_roll_joint': [-0.1, 0.1],
            'L_Hip_pitch_joint': [-0.1, 0.1],
            'L_Hip_roll_joint': [-0.1, 0.1],
            'L_Hip_yaw_joint': [-0.2, 0.2],
            'L_Knee_joint': [0.6, 0.7],
            'L_Ankle_pitch_joint': [-0.3, 0.0],
